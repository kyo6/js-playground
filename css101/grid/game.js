  ...
  setHandlers: function () {
    ...
    $(window)
      ...
      .on("hashchange", function () {
        ...
        $("#tweet iframe").remove();
        var html =
          '<a href="https://twitter.com/share" class="twitter-share-button"{count} data-url="http://cssgridgarden.com" data-via="thomashpark" data-text="I just beat Grid Garden, a game for learning CSS grid layout!">Tweet</a> ' +
